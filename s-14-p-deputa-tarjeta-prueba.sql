...
select nombre_usuario,nombre,ap_paterno,ap_materno,email,contasena,tipo
...
begin
  ...
  open cur_ver_elim_usuario;
    ...
    dbms_output.put_line('------------------------VISTOS DESDE UN CURSOR------------------------');
    v_var:=' Usuario_id ---------------- User  ----------------  Nombre ---------------- Apellido Paterno ---------------- Apellido Materno ---------------- Email ---------------- contasena ---------------- Tipo (NA sin actividad, VR vivienda Rentada, VV Vivienda Vendida y VA vivienda Alquilada)';
    dbms_output.put_line(v_var);
